...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-b from-blue-50 to-indigo-50 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="text-blue-700 font-semibold tracking-wider uppercase text-lg">
            Let's Connect
          </span>
          <h2 className="mt-3 text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-900 to-indigo-900 bg-clip-text text-transparent">
            Get In Touch
          </h2>
          <div className="mt-5 flex justify-center">
            <div className="w-24 h-1.5 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-full"></div>
          </div>
          <p className="mt-6 text-xl text-blue-800 max-w-2xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-10 mb-16">
          ...
          <div className="lg:w-1/3">
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-blue-100 h-full">
              ...
              <div className="space-y-6">
                ...
                <div className="pt-4">
                  <h4 className="text-lg font-semibold text-blue-900 mb-4">Follow Me</h4>
                  <div className="flex space-x-4">
                    <a href="https://x.com/b_h_a_r_g_a_v_1" className="text-blue-600 hover:text-blue-800 transition-colors">
                      <span className="sr-only">Twitter</span>
                      <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84"/>
                      </svg>
                    </a>
                    <a href="https://github.com/bhargavraju1" className="text-blue-600 hover:text-blue-800 transition-colors">
                    ...
                    <a href="https://www.linkedin.com/in/bhargav-raju-tamatam-827658284/" className="text-blue-600 hover:text-blue-800 transition-colors">
          ...
          <div className="lg:w-2/3">
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-blue-100 transform transition-all duration-300 hover:shadow-2xl">
              <h3 className="text-2xl font-bold text-blue-900 mb-6">
                Send Me a Message
              </h3>
                ...
                <div className="flex items-start">
                  <div className="flex items-center h-5 mt-0.5">
                    <input
                      ...
                      onChange={handleChange}
                      className="focus:ring-blue-500 h-4 w-4 text-blue-900 border-blue-300 rounded"
                    />
                  </div>
                  <div className="ml-3 text-sm">
                    ...
                    <p className="text-blue-600 mt-1">Get updates about my latest projects and articles</p>
                  </div>
                </div>
